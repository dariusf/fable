  ...
  $ node main_test.js ../programs/unicode.md
  {"type":"para","content":[{"type":"text","text":"“hello — don’t worry, we’ll be open 9–10…”"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/smartypants.md
  {"type":"para","content":[{"type":"text","text":"\"hello --- don't worry, we'll be open 9--10...\""}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/empty-section.md
  --- status: done, turns: 0

  $ node main_test.js ../programs/breaks.md
  ...
  $ node main_test.js ../programs/paragraph-break.md c
  ...
  $ node main_test.js ../programs/emphasis.md
  ...
  $ node main_test.js ../programs/comments.md
  ...
  $ node main_test.js ../programs/jump-links.md jump
  {"type":"para","content":[{"type":"link","linkId":0,"label":"jump"}]}
  --- activate: jump
  {"type":"para","content":[{"type":"text","text":"asd"}]}
  --- status: done, turns: 1

  $ node main_test.js ../programs/code-links.md code
  {"type":"para","content":[{"type":"link","linkId":0,"label":"code"}]}
  --- activate: code
  hi
  --- status: done, turns: 1

  $ node main_test.js ../programs/frontmatter.md
  {"type":"para","content":[{"type":"text","text":"hello"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/choices-precondition-seen.md a
  ...
  $ node main_test.js ../programs/choices-loose.md First
  ...
  $ node main_test.js ../programs/choices-tweet-style.md a
  ...
  $ node main_test.js ../programs/choices-tweet-style.md a c
  {"type":"choices","nodeId":2,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]},{"choiceId":1,"content":[{"type":"text","text":"c"}]}]}
  --- choose: a
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":2}
  ...
  $ node main_test.js ../programs/meta.md
  ...
  $ node main_test.js ../programs/error-non-string-meta.md
  {"type":"para","content":[{"type":"text","text":"1"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/interpolation.md a c
  ...
  $ node main_test.js ../programs/choices-continue.md 'continue'
  ...
  $ node main_test.js ../programs/choices-text.md x
  ...
  $ node main_test.js ../programs/choices-nested.md 'Choice 1' 'Nested choice. Did you choose choice 1?' 'Choice 2' 'Choice 3' 'Choice 4'
  ...
  $ node main_test.js ../programs/jump-dynamic.md
  {"type":"para","content":[{"type":"text","text":"Apple"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/choices-more.md
  ...
  $ node main_test.js ../programs/choices-copy.md
  {"type":"para","content":[{"type":"text","text":"text from Scene 1"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/choices-copy-scenes.md
  {"type":"para","content":[{"type":"text","text":"text from Scene 1"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/meta-undefined.md
  {"type":"para","content":[{"type":"text","text":"a"},{"type":"space"},{"type":"text","text":"b"},{"type":"space"},{"type":"text","text":"c"}]}
  {"type":"para","content":[{"type":"text","text":"after"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/tunnels.md
  {"type":"para","content":[{"type":"text","text":"1"}]}
  {"type":"para","content":[{"type":"text","text":"2"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/tunnels-followed-by-jumps.md
  {"type":"para","content":[{"type":"text","text":"before"}]}
  {"type":"para","content":[{"type":"text","text":"a"}]}
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"b"}]}]}
  --- status: awaiting, turns: 0

  $ node main_test.js ../programs/spaces.md 'choice text'
  ...
  $ node main_test.js ../programs/inline-and-block-meta.md
  ...
  $ node main_test.js ../programs/inline-meta-jump.md
  {"type":"para","content":[{"type":"text","text":"hi"},{"type":"space"},{"type":"text","text":"there"}]}
  {"type":"para","content":[{"type":"text","text":"b"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/block-meta-jump.md
  {"type":"para","content":[{"type":"text","text":"1"}]}
  {"type":"para","content":[{"type":"text","text":"2"}]}
  {"type":"para","content":[{"type":"text","text":"3"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/choices-break-delimiters.md
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"c1"}]}]}
  --- status: awaiting, turns: 0

  $ node main_test.js ../programs/choices-break-delimiters.md c1
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"c1"}]}]}
  --- choose: c1
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":1}
  ...
  $ node main_test.js ../programs/error-nonexistent-section.md Hello
  ...
  $ node main_test.js ../programs/choices-consumable.md c1
  ...
  $ node main_test.js ../programs/choices-sticky.md c1
  {"type":"choices","nodeId":2,"items":[{"choiceId":0,"content":[{"type":"text","text":"c1"}]},{"choiceId":1,"content":[{"type":"text","text":"c2"}]}]}
  --- choose: c1
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":2}
  ...
  $ node main_test.js ../programs/choices-otherwise.md
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- status: awaiting, turns: 0

  $ node main_test.js ../programs/choices-otherwise.md a
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- choose: a
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":1}
  ...
  $ node main_test.js ../programs/choices-fallthrough.md 'a'
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- choose: a
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":1}
  ...
  $ node main_test.js ../programs/choices-exhausted.md a b
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- choose: a
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":1}
  ...
  $ node main_test.js ../programs/api-local-state.md b a b a b
  ...
  $ node main_test.js ../programs/api-seen.md
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- status: awaiting, turns: 0

  $ node main_test.js ../programs/api-seen.md a
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- choose: a
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":1}
  ...
  $ node main_test.js ../programs/api-turns-since.md go back go
  {"type":"para","content":[{"type":"text","text":"since a:"},{"type":"space"},{"type":"text","text":"0"}]}
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"go"}]}]}
  --- choose: go
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":1}
  {"type":"para","content":[{"type":"text","text":"since a:"},{"type":"space"},{"type":"text","text":"1"},{"type":"text","text":", since b:"},{"type":"space"},{"type":"text","text":"0"}]}
  {"type":"choices","nodeId":3,"items":[{"choiceId":2,"content":[{"type":"text","text":"back"}]}]}
  --- choose: back
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":3}
  {"type":"para","content":[{"type":"text","text":"since a:"},{"type":"space"},{"type":"text","text":"0"}]}
  {"type":"choices","nodeId":5,"items":[{"choiceId":4,"content":[{"type":"text","text":"go"}]}]}
  --- choose: go
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":5}
  {"type":"para","content":[{"type":"text","text":"since a:"},{"type":"space"},{"type":"text","text":"1"},{"type":"text","text":", since b:"},{"type":"space"},{"type":"text","text":"0"}]}
  {"type":"choices","nodeId":7,"items":[{"choiceId":6,"content":[{"type":"text","text":"back"}]}]}
  --- status: awaiting, turns: 3

  $ node main_test.js ../programs/api-random.md
  {"type":"para","content":[{"type":"text","text":"roll:"},{"type":"space"},{"type":"text","text":"3"},{"type":"text","text":", coin:"},{"type":"space"},{"type":"text","text":"false"},{"type":"text","text":", pick:"},{"type":"space"},{"type":"text","text":"y"},{"type":"text","text":", float below one:"},{"type":"space"},{"type":"text","text":"true"}]}
  --- status: done, turns: 0

  $ node main_test.js ../programs/api-last-choice.md second
  {"type":"choices","nodeId":2,"items":[{"choiceId":0,"content":[{"type":"text","text":"first"}]},{"choiceId":1,"content":[{"type":"text","text":"second"}]}]}
  --- choose: second
  {"type":"markOld"}
  {"type":"removeChoices","nodeId":2}
  {"type":"para","content":[{"type":"text","text":"you chose"},{"type":"space"},{"type":"text","text":"second"}]}
  --- status: done, turns: 1

  $ node main_test.js ../programs/jump-to-current-section.md a
  {"type":"para","content":[{"type":"text","text":"hello"}]}
  {"type":"choices","nodeId":1,"items":[{"choiceId":0,"content":[{"type":"text","text":"a"}]}]}
  --- choose: a
  {"type":"markOld"}
...
It is no longer possible to use Meta-more to refer to an existing section.
  ...
  $ node main_test.js ../programs/error-dynamic-more.md
...
It is no longer possible to define a section using Meta.
  ...
  $ node main_test.js ../programs/error-dynamic-section.md
  {"type":"para","content":[{"type":"text","text":"hello"}]}
  {"type":"error","message":"Jump: section a not found"}
  --- status: stuck, turns: 0
